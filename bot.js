...
client.on("message", message => {
 ...
 if (message.content === "!help") {
  ...
  const embed = new Discord.RichEmbed()
      ...
      .addField("『!                    x'1Kemuda .#6334 مصمم البوت』", true)
...
client.on('ready', function(){
    var ms = 60000 ;
    var setGame = [`${client.guilds.size} Server`,'$help','Type $help','ExPlosive By !                    x'1Kemuda .#6334 '`${client.users.size} Members`,'!inv','By: Mohamed '];
    var i = -1;
    var j = 0;
    setInterval(function (){
        if( i == -1 ){
...
const developers = ["415142691282616330","415142691282616330",""]
const adminprefix = "!";
client.on('message', message => {
